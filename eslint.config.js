...
module.exports = [
  ...
  prettierConfig,
  {
    ignores: [
      ...
      // Deno, not React Native. Different globals and a different runtime;
      // linting them with this config only produces false positives.
      'supabase/functions/**',
    ],
  },
  {
  ...
  {
    // Repositories are what the rule above points UI code at, so they are
    // where the client is meant to be used.
